...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getLatestVersion() {
      fetch("https://api.github.com/repos/bynabil/nativescript-bustiming/releases").then(response => response.json()).then(json => {
...
var render = function() {
  ...
  return _c(
    "Page",
    [
      _c("ActionBar", { attrs: { title: "bustimings" } }),
      _c(
        "TabView",
        {
          attrs: {
            ...
            [
              _c(
                ...
                [
                  _c(
                    "StackLayout",
                    { staticClass: "addmargin" },
                    [
                      _c("Label", {
                        staticClass: "message alert",
                        attrs: {
                          textWrap: "true",
                          text: _vm.updateMessage,
                          col: "0",
                          row: "0"
                        },
                        on: { tap: _vm.openUpdate }
                      }),
                      _c(
                        "Label",
                        {
                        ...
                        [_vm._v("Bus Stop Code")]
                      ),
                      _c("Textfield", {
                        attrs: { text: _vm.stopid },
                        on: {
                          textChange: [
                            function($event) {
                              _vm.stopid = $event.value
                            },
                            _vm.getBusStop
                          ]
                        }
                      ...
                      _c(
                        "ListView",
                        {
                          ...
                          attrs: { items: _vm.data.services, "+alias": "bus" },
                          on: { itemTap: _vm.toast_info }
                        },
                        [
                          _c("v-template", {
                            scopedSlots: _vm._u([
                                ...
                                fn: function(ref) {
                                  ...
                                  return _c(
                                    ...
                                    [
                                      _c("Label", {
                                        staticClass:
                                          "list-group-item-heading bold",
                                        staticStyle: { width: "60%" },
                                        attrs: { text: bus.no }
                                      }),
                                      Math.floor(
                                        bus.next.duration_ms / 60000
                                      ) <= 1
                                        ? _c(
                                            "StackLayout",
                                            [
                                      ...
                                      Math.floor(
                                        bus.subsequent.duration_ms / 60000
                                      ) <= 1
                                        ? _c(
                                            "StackLayout",
                                            [
...
module.exports = {"android":{"v8Flags":"--expose_gc"},"main":"main","name":"bustiming-app","version":"1.0.0"};
